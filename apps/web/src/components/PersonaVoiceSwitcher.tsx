...
export function PersonaVoiceSwitcher({
  ...
  return (
    <div className={cn("relative", className)} ref={rootRef}>
      ...
      {isOpen ? (
        <div
          className="absolute bottom-full left-0 z-20 mb-2 w-full min-w-[280px] rounded-token-s border border-[var(--color-border-opaque)] bg-white p-2 shadow-[0_18px_44px_rgba(18,19,24,0.16)]"
          role="listbox"
        >
