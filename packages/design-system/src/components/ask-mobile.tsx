...
export function AskMobileExperience({
  ...
  return (
    ...
    >
      ...
      {showConversation ? (
        <div
          className="right-token-20 left-token-20 absolute bottom-[230px] top-[112px] overflow-y-auto pb-[28px] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
      ...
      <div className="right-token-20 bottom-token-20 left-token-20 gap-token-8 absolute z-10 flex flex-col">
        {isVoicePanelOpen ? (
          <VoiceParameterPanel
            className="w-full"
