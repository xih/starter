...
export function AgentControlBar({
  ...
  return (
    <div
      ...
      data-state={state}
    >
      <div className="gap-token-8 flex h-[28px] items-center">
        <input
          aria-label="Message"
          className="font-body font-regular min-w-0 flex-1 bg-transparent text-[14px] leading-[20px] text-[#595a5d] outline-none placeholder:text-[#595a5d]"
