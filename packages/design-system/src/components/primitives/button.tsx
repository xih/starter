...
export function DesignSystemButton({
  ...
  return (
    <button
      className={cn(
        "inline-flex shrink-0 items-center justify-center gap-[10px] rounded-[8px] border font-body text-[14px] font-[700] leading-[20px] transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#121318] focus-visible:ring-offset-2",
        size === "large"
