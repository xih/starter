...
export default function WalletPage() {
  ...
  const redEnvelopeVariants: Variants = {
    initial: {
      scale: 0.5,
      opacity: 0,
      x: 0,
    ...
    <SidebarProvider>
      ...
      <SidebarInset className="overflow-hidden">
        <header className="flex h-14 shrink-0 items-center border-b border-border bg-background px-4 md:hidden">
          <SidebarTrigger />
          <span className="ml-2 text-sm font-semibold">Wallet</span>
        </header>
        <div className="relative flex min-h-0 flex-1 items-center justify-center overflow-auto bg-background p-4">
          {/* Wallet counter */}
